...
"[project]/node_modules/@hpcc-js/wasm-graphviz/dist/index.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var un = ArrayBuffer, $ = Uint8Array, $e = Uint16Array, cn = Int16Array;
var Ve = Int32Array, cr = function(c, _, l) {
    if ($.prototype.slice) return $.prototype.slice.call(c, _, l);
    (_ == null || _ < 0) && (_ = 0), (l == null || l > c.length) && (l = c.length);
    var s = new $(l - _);
    return s.set(c.subarray(_, l)), s;
}, Ue = function(c, _, l, s) {
    if ($.prototype.fill) return $.prototype.fill.call(c, _, l, s);
    for((l == null || l < 0) && (l = 0), (s == null || s > c.length) && (s = c.length); l < s; ++l)c[l] = _;
    return c;
}, fn = function(c, _, l, s) {
    if ($.prototype.copyWithin) return $.prototype.copyWithin.call(c, _, l, s);
    for((l == null || l < 0) && (l = 0), (s == null || s > c.length) && (s = c.length); l < s;)c[_++] = c[l++];
};
var _n = [
    "invalid zstd data",
    ...
    var s = new Error(_ || _n[c]);
    if (s.code = c, Error.captureStackTrace && Error.captureStackTrace(s, V), !l) throw s;
    return s;
}, Hr = function(c, _, l) {
    for(var s = 0, d = 0; s < l; ++s)d |= c[_++] << (s << 3);
    return d;
}, ln = function(c, _) {
    return (c[_] | c[_ + 1] << 8 | c[_ + 2] << 16 | c[_ + 3] << 24) >>> 0;
}, dn = function(c, _) {
    var l = c[0] | c[1] << 8 | c[2] << 16;
    if (l == 3126568 && c[3] == 253) {
        var s = c[4], d = s >> 5 & 1, h = s >> 2 & 1, p = s & 3, E = s >> 6;
        s & 8 && V(0);
        var G = 6 - d, j = p == 3 ? 4 : p, q = Hr(c, G, j);
        G += j;
        var U = E ? 1 << E : d, H = Hr(c, G, U) + (E == 1 && 256), K = H;
        if (!d) {
            var J = 1 << 10 + (c[5] >> 3);
            K = J + (J >> 3) * (c[5] & 7);
        }
        K > 2145386496 && V(1);
        var L = new $((_ == 1 ? H || K : _ ? 0 : K) + 12);
        return L[0] = 1, L[4] = 4, L[8] = 8, {
            b: G + U,
            y: 0,
            l: 0,
            d: q,
            w: _ && _ != 1 ? _ : L.subarray(12),
            e: K,
            o: new Ve(L.buffer, 0, 3),
            u: H,
            c: h,
            m: Math.min(131072, K)
        };
    } else if ((l >> 4 | c[3] << 20) == 25481893) return ln(c, 4) + 8;
    V(0);
}, Le = function(c) {
    for(var _ = 0; 1 << _ <= c; ++_);
    return _ - 1;
}, He = function(c, _, l) {
    var s = (_ << 3) + 4, d = (c[_] & 15) + 5;
    d > l && V(3);
    for(var h = 1 << d, p = h, E = -1, G = -1, j = -1, q = h, U = new un(512 + (h << 2)), H = new cn(U, 0, 256), K = new $e(U, 0, 256), J = new $e(U, 512, h), L = 512 + (h << 1), T = new $(U, L, h), te = new $(U, L + h); E < 255 && p > 0;){
        var X = Le(p + 1), W = s >> 3, fe = (1 << X + 1) - 1, C = (c[W] | c[W + 1] << 8 | c[W + 2] << 16) >> (s & 7) & fe, m = (1 << X) - 1, Q = fe - p - 1, k = C & m;
        if (k < Q ? (s += X, C = k) : (s += X + 1, C > m && (C -= Q)), H[++E] = --C, C == -1 ? (p += C, T[--q] = E) : p -= C, !C) do {
            var ie = s >> 3;
            G = (c[ie] | c[ie + 1] << 8) >> (s & 7) & 3, s += 2, E += G;
        }while (G == 3)
    }
    (E > 255 || p) && V(0);
    for(var B = 0, R = (h >> 1) + (h >> 3) + 3, ae = h - 1, ne = 0; ne <= E; ++ne){
        var Z = H[ne];
        if (Z < 1) {
            K[ne] = -Z;
            continue;
    ...
    var l = 0, s = -1, d = new $(292), h = c[_], p = d.subarray(0, 256), E = d.subarray(256, 268), G = new $e(d.buffer, 268);
    if (h < 128) {
        var j = He(c, _ + 1, 6), q = j[0], U = j[1];
        _ += h;
        var H = q << 3, K = c[_];
        K || V(0);
        for(var J = 0, L = 0, T = U.b, te = T, X = (++_ << 3) - 8 + Le(K); X -= T, !(X < H);){
            var W = X >> 3;
            if (J += (c[W] | c[W + 1] << 8) >> (X & 7) & (1 << T) - 1, p[++s] = U.s[J], X -= te, X < H) break;
            W = X >> 3, L += (c[W] | c[W + 1] << 8) >> (X & 7) & (1 << te) - 1, p[++s] = U.s[L], T = U.n[J], J = U.t[J], te = U.n[L], L = U.t[L];
        }
        ++s > 255 && V(0);
    } else {
        for(s = h - 127; l < s; l += 2){
            var fe = c[++_];
            p[l] = fe >> 4, p[l + 1] = fe & 15;
        }
        ++_;
    }
    var C = 0;
    ...
    var Q = Le(C) + 1, k = 1 << Q, ie = k - C;
    for(ie & ie - 1 && V(0), p[s++] = Le(ie) + 1, l = 0; l < s; ++l){
        var m = p[l];
        ++E[p[l] = m && Q + 1 - m];
    }
    var B = new $(k << 1), R = B.subarray(0, k), ae = B.subarray(k);
    for(G[Q] = 0, l = Q; l > 0; --l){
        var ne = G[l];
        Ue(ae, l, ne, G[l - 1] = ne + E[l] * (1 << Q - l));
    }
    for(G[0] != k && V(0), l = 0; l < s; ++l){
        var Z = p[l];
        if (Z) {
            var I = G[Z];
            Ue(R, l, I, G[Z] = I + (1 << Q - Z));
        }
    }
    return [
        _,
    ...
    73,
    2
]), 0, 5)[1], Kr = function(c, _) {
    for(var l = c.length, s = new Ve(l), d = 0; d < l; ++d)s[d] = _, _ += 1 << c[d];
    return s;
}, fr = new $(new Ve([
    0,
    0,
    ...
    202050057,
    269422093
]).buffer, 0, 36), En = Kr(fr, 0), _r = new $(new Ve([
    0,
    0,
    0,
    0,
    ...
    252579084,
    16
]).buffer, 0, 53), mn = Kr(_r, 3), je = function(c, _, l) {
    var s = c.length, d = _.length, h = c[s - 1], p = (1 << l.b) - 1, E = -l.b;
    h || V(0);
    for(var G = 0, j = l.b, q = (s << 3) - 8 + Le(h) - j, U = -1; q > E && U < d;){
        var H = q >> 3, K = (c[H] | c[H + 1] << 8 | c[H + 2] << 16) >> (q & 7);
        G = (G << j | K) & p, _[++U] = l.s[G], q -= j = l.n[G];
    }
    (q != E || U + 1 != d) && V(0);
}, wn = function(c, _, l) {
    var s = 6, d = _.length, h = d + 3 >> 2, p = h << 1, E = h + p;
    je(c.subarray(s, s += c[0] | c[1] << 8), _.subarray(0, h), l), je(c.subarray(s, s += c[2] | c[3] << 8), _.subarray(h, p), l), je(c.subarray(s, s += c[4] | c[5] << 8), _.subarray(p, E), l), je(c.subarray(s), _.subarray(E), l);
}, Bn = function(c, _, l) {
    var s, d = _.b, h = c[d], p = h >> 1 & 3;
    _.l = h & 1;
    var E = h >> 3 | c[d + 1] << 5 | c[d + 2] << 13, G = (d += 3) + E;
    if (p == 1) return d >= c.length ? void 0 : (_.b = d + 1, l ? (Ue(l, c[d], _.y, _.y += E), l) : Ue(new $(E), c[d]));
    if (!(G > c.length)) {
        if (p == 0) return _.b = G, l ? (l.set(c.subarray(d, G), _.y), _.y += E, l) : cr(c, d, G);
        if (p == 2) {
            var j = c[d], q = j & 3, U = j >> 2 & 3, H = j >> 4, K = 0, J = 0;
            q < 2 ? U & 1 ? H |= c[++d] << 4 | (U & 2 && c[++d] << 12) : H = j >> 3 : (J = U, U < 2 ? (H |= (c[++d] & 63) << 4, K = c[d] >> 6 | c[++d] << 2) : U == 2 ? (H |= c[++d] << 4 | (c[++d] & 3) << 12, K = c[d] >> 2 | c[++d] << 6) : (H |= c[++d] << 4 | (c[++d] & 63) << 12, K = c[d] >> 6 | c[++d] << 2 | c[++d] << 10)), ++d;
            var L = l ? l.subarray(_.y, _.y + _.m) : new $(_.m), T = L.length - H;
            if (q == 0) L.set(c.subarray(d, d += H), T);
            else if (q == 1) Ue(L, c[d++], T);
            else {
                var te = _.h;
                if (q == 2) {
                    var X = vn(c, d);
                    K += d - (d = X[0]), _.h = te = X[1];
                } else te || V(0);
                (J ? wn : je)(c.subarray(d, d += K), L.subarray(T), te);
            }
            var W = c[d++];
            if (W) {
                W == 255 ? W = (c[d++] | c[d++] << 8) + 32512 : W > 127 && (W = W - 128 << 8 | c[d++]);
                var fe = c[d++];
                fe & 3 && V(0);
                for(var C = [
                    pn,
                    ...
                    if (Q == 1) {
                        ...
                        C[m] = {
                            s: k.subarray(2, 3),
                            n: k.subarray(0, 1),
                            t: new $e(k.buffer, 0, 1),
                            b: 0
                        };
                    } else Q == 2 ? (s = He(c, d, 9 - (m & 1)), d = s[0], C[m] = s[1]) : Q == 3 && (_.t || V(0), C[m] = _.t[m]);
                }
                var ie = _.t = C, B = ie[0], R = ie[1], ae = ie[2], ne = c[G - 1];
                ne || V(0);
                var Z = (G << 3) - 8 + Le(ne) - ae.b, I = Z >> 3, A = 0, Ie = (c[I] | c[I + 1] << 8) >> (Z & 7) & (1 << ae.b) - 1;
                I = (Z -= R.b) >> 3;
                var xe = (c[I] | c[I + 1] << 8) >> (Z & 7) & (1 << R.b) - 1;
                I = (Z -= B.b) >> 3;
                var Oe = (c[I] | c[I + 1] << 8) >> (Z & 7) & (1 << B.b) - 1;
                for(++W; --W;){
                    var Pe = ae.s[Ie], Qe = ae.n[Ie], Te = B.s[Oe], me = B.n[Oe], be = R.s[xe], we = R.n[xe];
                    I = (Z -= be) >> 3;
                    var qe = 1 << be, _e = qe + ((c[I] | c[I + 1] << 8 | c[I + 2] << 16 | c[I + 3] << 24) >>> (Z & 7) & qe - 1);
                    I = (Z -= _r[Te]) >> 3;
                    var he = mn[Te] + ((c[I] | c[I + 1] << 8 | c[I + 2] << 16) >> (Z & 7) & (1 << _r[Te]) - 1);
                    I = (Z -= fr[Pe]) >> 3;
                    var pe = En[Pe] + ((c[I] | c[I + 1] << 8 | c[I + 2] << 16) >> (Z & 7) & (1 << fr[Pe]) - 1);
                    if (I = (Z -= Qe) >> 3, Ie = ae.t[Ie] + ((c[I] | c[I + 1] << 8) >> (Z & 7) & (1 << Qe) - 1), I = (Z -= me) >> 3, Oe = B.t[Oe] + ((c[I] | c[I + 1] << 8) >> (Z & 7) & (1 << me) - 1), I = (Z -= we) >> 3, xe = R.t[xe] + ((c[I] | c[I + 1] << 8) >> (Z & 7) & (1 << we) - 1), _e > 3) _.o[2] = _.o[1], _.o[1] = _.o[0], _.o[0] = _e -= 3;
                    else {
                        var Me = _e - (pe != 0);
                        Me ? (_e = Me == 3 ? _.o[0] - 1 : _.o[Me], Me > 1 && (_.o[2] = _.o[1]), _.o[1] = _.o[0], _.o[0] = _e) : _e = _.o[0];
                    }
                    for(var m = 0; m < pe; ++m)L[A + m] = L[T + m];
                    A += pe, T += pe;
                    var Be = A - _e;
                    if (Be < 0) {
                        var Fe = -Be, Je = _.e + Be;
                        Fe > he && (Fe = he);
                        for(var m = 0; m < Fe; ++m)L[A + m] = _.w[Je + m];
                        A += Fe, he -= Fe, Be = 0;
                    }
                    for(var m = 0; m < he; ++m)L[A + m] = L[Be + m];
                    A += he;
                }
                if (A != T) for(; T < L.length;)L[A++] = L[T++];
                else A = L.length;
                l ? _.y += A : L = cr(L, 0, A);
            } else if (l) {
                if (_.y += H, T) for(var m = 0; m < H; ++m)L[m] = L[T + m];
            } else T && (L = cr(L, T));
            return _.b = G, L;
        }
        V(2);
    ...
    for(var l = new $(_), s = 0, d = 0; s < c.length; ++s){
        var h = c[s];
...
function Qr(c, _) {
    for(var l = [], s = +!_, d = 0, h = 0; c.length;){
        var p = dn(c, s || _);
        if (typeof p == "object") {
            for(s ? (_ = null, p.w.length == p.u && (l.push(_ = p.w), h += p.u)) : (l.push(_), p.e = 0); !p.l;){
                var E = Bn(c, p, _);
                E || V(5), _ ? p.e = p.y : (l.push(E), h += E.length, fn(p.w, 0, E.length), p.w.set(E, p.w.length - E.length));
            }
            d = p.b + p.c * 4;
        } else d = p;
        c = c.subarray(d);
...
var Gn = (()=>{
    ...
    return function(_ = {}) {
        var l, s = _, d, h, p = new Promise((e, r)=>{
            d = e, h = r;
        }), E = !1, G = Object.assign({}, s), j = "./this.program", q = (e, r)=>{
            throw r;
        }, U = "";
        function H(e) {
            return U + e;
        }
        var K, J, L = console.log.bind(console), T = console.error.bind(console);
        Object.assign(s, G), G = null;
        var te = s.wasmBinary, X, W = !1, fe;
        function C(e, r) {
            e || pe(r);
        }
        var m, Q, k, ie, B, R, ae, ne;
        function Z() {
            var e = X.buffer;
            s.HEAP8 = m = new Int8Array(e), s.HEAP16 = k = new Int16Array(e), s.HEAPU8 = Q = new Uint8Array(e), s.HEAPU16 = ie = new Uint16Array(e), s.HEAP32 = B = new Int32Array(e), s.HEAPU32 = R = new Uint32Array(e), s.HEAPF32 = ae = new Float32Array(e), s.HEAPF64 = ne = new Float64Array(e);
        }
        var I = [], A = [], Ie = [], xe = !1;
        function Oe() {
            ke(I);
        ...
        function Pe() {
            xe = !0, !s.noFSInit && !n.initialized && n.init(), n.ignorePermissions = !1, Ge.init(), ke(A);
        }
        function Qe() {
            ke(Ie);
        }
        ...
        function he(e) {
            if (me--, me == 0 && (be !== null && (clearInterval(be), be = null), we)) {
                var r = we;
                we = null, r();
            }
        }
        function pe(e) {
            e = "Aborted(" + e + ")", T(e), W = !0, e += ". Build with -sASSERTIONS for more info.";
            var r = new WebAssembly.RuntimeError(e);
            throw h(r), r;
        }
        var Me = "data:application/octet-stream;base64,", Be = (e)=>e.startsWith(Me), Fe = (e)=>e.startsWith("file://");
        function Je() {
        ...
        var Ne;
        function dr(e) {
            if (e == Ne && te) return new Uint8Array(te);
            if (J) return J(e);
            throw "both async and sync fetching of the wasm failed";
        }
        function Vr(e) {
            return te ? Promise.resolve().then(()=>dr(e)) : K(e).then((r)=>new Uint8Array(r), ()=>dr(e));
        }
        function vr(e, r, t) {
            return Vr(e).then((o)=>WebAssembly.instantiate(o, r)).then(t, (o)=>{
                T(`failed to asynchronously prepare wasm: ${o}`), pe(o);
            });
        }
        function qr(e, r, t, o) {
            return !e && typeof WebAssembly.instantiateStreaming == "function" && !Be(r) && !Fe(r) && typeof fetch == "function" ? fetch(r, {
                credentials: "same-origin"
            }).then((i)=>{
                var a = WebAssembly.instantiateStreaming(i, t);
                return a.then(o, function(u) {
                    return T(`wasm streaming compile failed: ${u}`), T("falling back to ArrayBuffer instantiation"), vr(r, t, o);
                });
            }) : vr(r, t, o);
        }
        function Jr() {
        ...
        function Nr() {
            function e(o, i) {
                return z = o.exports, X = z.B, Z(), Te(z.C), he("wasm-instantiate"), z;
            }
            _e("wasm-instantiate");
            function r(o) {
                e(o.instance);
            ...
            var t = Jr();
            return Ne ??= Je(), qr(te, Ne, t, r).catch(h), {};
        }
        var O, N, kr = {
            173064: (e, r)=>{
                var t = se(e), o = se(r);
                n.createPath("/", S.dirname(t)), n.writeFile(S.join("/", t), o);
            }
        };
        class Ar {
            name = "ExitStatus";
        ...
        var hr = 0, rt = 0, tt = (e, r, t)=>{
            var o = new et(e);
            throw o.init(r, t), hr = e, rt++, hr;
        }, S = {
            isAbs: (e)=>e.charAt(0) === "/",
            splitPath: (e)=>{
                var r = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/;
            ...
            normalize: (e)=>{
                var r = S.isAbs(e), t = e.substr(-1) === "/";
                return e = S.normalizeArray(e.split("/").filter((o)=>!!o), !r).join("/"), !e && !r && (e = "."), e && t && (e += "/"), (r ? "/" : "") + e;
            },
            dirname: (e)=>{
                var r = S.splitPath(e), t = r[0], o = r[1];
                return !t && !o ? "." : (o && (o = o.substr(0, o.length - 1)), t + o);
            },
            basename: (e)=>{
                if (e === "/") return "/";
                e = S.normalize(e), e = e.replace(/\/$/, "");
                var r = e.lastIndexOf("/");
                return r === -1 ? e : e.substr(r + 1);
            },
            join: (...e)=>S.normalize(e.join("/")),
            join2: (e, r)=>S.normalize(e + "/" + r)
        }, nt = ()=>{
            ...
            resolve: (...e)=>{
                ...
                return r = S.normalizeArray(r.split("/").filter((a)=>!!a), !t).join("/"), (t ? "/" : "") + r || ".";
            },
            relative: (e, r)=>{
                e = ge.resolve(e).substr(1), r = ge.resolve(r).substr(1);
                function t(F) {
                    for(var b = 0; b < F.length && F[b] === ""; b++);
                    for(var Y = F.length - 1; Y >= 0 && F[Y] === ""; Y--);
                    return b > Y ? [] : F.slice(b, Y - b + 1);
                }
                for(var o = t(e.split("/")), i = t(r.split("/")), a = Math.min(o.length, i.length), u = a, f = 0; f < a; f++)if (o[f] !== i[f]) {
                    u = f;
                    break;
                }
                for(var v = [], f = u; f < o.length; f++)v.push("..");
                return v = v.concat(i.slice(u)), v.join("/");
            }
        }, yr = typeof TextDecoder < "u" ? new TextDecoder : void 0, Re = (e, r = 0, t = NaN)=>{
            for(var o = r + t, i = r; e[i] && !(i >= o);)++i;
            if (i - r > 16 && e.buffer && yr) return yr.decode(e.subarray(r, i));
            for(var a = ""; r < i;){
                var u = e[r++];
                if (!(u & 128)) {
                ...
                var f = e[r++] & 63;
                if ((u & 224) == 192) {
                    a += String.fromCharCode((u & 31) << 6 | f);
                    continue;
                }
                var v = e[r++] & 63;
                if ((u & 240) == 224 ? u = (u & 15) << 12 | f << 6 | v : u = (u & 7) << 18 | f << 12 | v << 6 | e[r++] & 63, u < 65536) a += String.fromCharCode(u);
                else {
                    var F = u - 65536;
            ...
            if (!(o > 0)) return 0;
            for(var i = t, a = t + o - 1, u = 0; u < e.length; ++u){
                ...
                if (f <= 127) {
                    ...
                    if (t + 1 >= a) break;
                    r[t++] = 192 | f >> 6, r[t++] = 128 | f & 63;
                } else if (f <= 65535) {
                    if (t + 2 >= a) break;
                    r[t++] = 224 | f >> 12, r[t++] = 128 | f >> 6 & 63, r[t++] = 128 | f & 63;
                } else {
                    if (t + 3 >= a) break;
                    r[t++] = 240 | f >> 18, r[t++] = 128 | f >> 12 & 63, r[t++] = 128 | f >> 6 & 63, r[t++] = 128 | f & 63;
                }
            }
            return r[t] = 0, t - i;
        };
        function tr(e, r, t) {
            var o = t > 0 ? t : er(e) + 1, i = new Array(o), a = rr(e, i, 0, i.length);
        ...
        var ot = ()=>{
            ...
            register (e, r) {
                Ge.ttys[e] = {
                    ...
                    output: [],
                    ops: r
                }, n.registerDevice(e, Ge.stream_ops);
            },
            stream_ops: {
                open (e) {
                ...
                read (e, r, t, o, i) {
                    ...
                    for(var a = 0, u = 0; u < o; u++){
                        var f;
                        try {
                            f = e.tty.ops.get_char(e.tty);
                        } catch  {
                            throw new n.ErrnoError(29);
                        }
                        if (f === void 0 && a === 0) throw new n.ErrnoError(6);
                        if (f == null) break;
                        a++, r[t + u] = f;
                    }
            ...
            default_tty_ops: {
                ...
                put_char (e, r) {
                    r === null || r === 10 ? (L(Re(e.output)), e.output = []) : r != 0 && e.output.push(r);
                },
                fsync (e) {
                    e.output && e.output.length > 0 && (L(Re(e.output)), e.output = []);
                },
                ioctl_tcgets (e) {
                    return {
                        c_iflag: 25856,
            ...
            default_tty1_ops: {
                ...
                fsync (e) {
                    e.output && e.output.length > 0 && (T(Re(e.output)), e.output = []);
                }
            }
        }, it = (e, r)=>{
            Q.fill(0, e, e + r);
        }, nr = (e, r)=>Math.ceil(e / r) * r, Er = (e)=>{
            e = nr(e, 65536);
            var r = jr(65536, e);
            return r && it(r, e), r;
        }, g = {
                ...
                g.ops_table ||= {
                    ...
                    file: {
                        ...
                        stream: {
                            ...
                            allocate: g.stream_ops.allocate,
            ...
            node_ops: {
                getattr (e) {
                    var r = {};
                    return r.dev = n.isChrdev(e.mode) ? e.id : 1, r.ino = e.id, r.mode = e.mode, r.nlink = 1, r.uid = 0, r.gid = 0, r.rdev = e.rdev, n.isDir(e.mode) ? r.size = 4096 : n.isFile(e.mode) ? r.size = e.usedBytes : n.isLink(e.mode) ? r.size = e.link.length : r.size = 0, r.atime = new Date(e.timestamp), r.mtime = new Date(e.timestamp), r.ctime = new Date(e.timestamp), r.blksize = 4096, r.blocks = Math.ceil(r.size / r.blksize), r;
                },
                setattr (e, r) {
                    r.mode !== void 0 && (e.mode = r.mode), r.timestamp !== void 0 && (e.timestamp = r.timestamp), r.size !== void 0 && g.resizeFileStorage(e, r.size);
                },
                lookup (e, r) {
                    throw g.doesNotExistError;
                },
                mknod (e, r, t, o) {
                ...
                rename (e, r, t) {
                    ...
                    delete e.parent.contents[e.name], e.parent.timestamp = Date.now(), e.name = t, r.contents[t] = e, r.timestamp = e.parent.timestamp;
                },
                unlink (e, r) {
            ...
            stream_ops: {
                read (e, r, t, o, i) {
                    ...
                    var u = Math.min(e.node.usedBytes - i, o);
                    if (u > 8 && a.subarray) r.set(a.subarray(i, i + u), t);
                    else for(var f = 0; f < u; f++)r[t + f] = a[i + f];
                    return u;
                },
                write (e, r, t, o, i, a) {
                    if (r.buffer === m.buffer && (a = !1), !o) return 0;
                    var u = e.node;
                    if (u.timestamp = Date.now(), r.subarray && (!u.contents || u.contents.subarray)) {
                        if (a) return u.contents = r.subarray(t, t + o), u.usedBytes = o, o;
                        if (u.usedBytes === 0 && i === 0) return u.contents = r.slice(t, t + o), u.usedBytes = o, o;
                        if (i + o <= u.usedBytes) return u.contents.set(r.subarray(t, t + o), i), o;
                    }
                    if (g.expandFileStorage(u, i + o), u.contents.subarray && r.subarray) u.contents.set(r.subarray(t, t + o), i);
                    else for(var f = 0; f < o; f++)u.contents[i + f] = r[t + f];
                ...
                allocate (e, r, t) {
                    g.expandFileStorage(e.node, r + t), e.node.usedBytes = Math.max(e.node.usedBytes, r + t);
                },
                mmap (e, r, t, o, i) {
                    if (!n.isFile(e.node.mode)) throw new n.ErrnoError(43);
                    var a, u, f = e.node.contents;
                    if (!(i & 2) && f && f.buffer === m.buffer) u = !1, a = f.byteOffset;
                    else {
                        if (u = !0, a = Er(r), !a) throw new n.ErrnoError(48);
                        f && ((t > 0 || t + r < f.length) && (f.subarray ? f = f.subarray(t, t + r) : f = Array.prototype.slice.call(f, t, t + r)), m.set(f, a));
                    }
                    return {
                        ptr: a,
                        allocated: u
                ...
                msync (e, r, t, o, i) {
                    return g.stream_ops.write(e, r, 0, o, t, !1), 0;
                }
            }
        }, at = (e, r, t, o)=>{
            var i = o ? "" : `al ${e}`;
            K(e).then((a)=>{
                r(new Uint8Array(a)), i && he(i);
            }, (a)=>{
                if (t) t();
            ...
            var i = !1;
            return ut.forEach((a)=>{
                i || a.canHandle(r) && (a.handle(e, r, t, o), i = !0);
            }), i;
        }, ft = (e, r, t, o, i, a, u, f, v, F)=>{
            var b = r ? ge.resolve(S.join2(e, r)) : e, Y = `cp ${b}`;
            function x(w) {
                function M(ee) {
                    F?.(), f || st(e, r, ee, o, i, v), a?.(), he(Y);
                }
                ct(w, b, M, ()=>{
                    u?.(), he(Y);
                }) || M(w);
            }
            _e(Y), typeof t == "string" ? at(t, x, u) : x(t);
        }, _t = (e)=>{
            var r = {
                r: 0,
                "r+": 2,
            ...
            FSNode: class {
                ...
                mounted = null;
                constructor(e, r, t, o){
                    e || (e = this), this.parent = e, this.mount = e.mount, this.id = n.nextInode++, this.name = r, this.mode = t, this.rdev = o;
                }
                get read() {
            ...
            lookupPath (e, r = {}) {
                ...
                if (r = Object.assign(t, r), r.recurse_count > 8) throw new n.ErrnoError(32);
                for(var o = e.split("/").filter((Y)=>!!Y), i = n.root, a = "/", u = 0; u < o.length; u++){
                    var f = u === o.length - 1;
                    if (f && r.parent) break;
                    if (i = n.lookupNode(i, o[u]), a = S.join2(a, o[u]), n.isMountpoint(i) && (!f || f && r.follow_mount) && (i = i.mounted.root), !f || r.follow) for(var v = 0; n.isLink(i.mode);){
                        var F = n.readlink(a);
                        a = ge.resolve(S.dirname(a), F);
                        var b = n.lookupPath(a, {
                            recurse_count: r.recurse_count + 1
                        });
                        if (i = b.node, v++ > 40) throw new n.ErrnoError(32);
                    }
                }
                return {
                    path: a,
            ...
            mayOpen (e, r) {
                return e ? n.isLink(e.mode) ? 32 : n.isDir(e.mode) && (n.flagsToPermissionString(r) !== "r" || r & 512) ? 31 : n.nodePermissions(e, n.flagsToPermissionString(r)) : 44;
            },
            MAX_OPEN_FDS: 4096,
            nextfd () {
            ...
            syncfs (e, r) {
                typeof e == "function" && (r = e, e = !1), n.syncFSRequests++, n.syncFSRequests > 1 && T(`warning: ${n.syncFSRequests} FS.syncfs operations in flight at once, probably just doing extra work`);
                var t = n.getMounts(n.root.mount), o = 0;
                function i(u) {
                    return n.syncFSRequests--, r(u);
                }
                function a(u) {
                    if (u) return a.errored ? void 0 : (a.errored = !0, i(u));
                    ++o >= t.length && i(null);
                }
                t.forEach((u)=>{
            ...
            mount (e, r, t) {
                ...
                return v.mount = f, f.root = v, o ? n.root = v : a && (a.mounted = f, a.mount && a.mount.mounts.push(f)), v;
            },
            unmount (e) {
                ...
                Object.keys(n.nameTable).forEach((u)=>{
                    for(var f = n.nameTable[u]; f;){
                        var v = f.name_next;
                        i.includes(f.mount) && n.destroyNode(f), f = v;
                    }
                }), t.mounted = null;
            ...
            mkdirTree (e, r) {
                for(var t = e.split("/"), o = "", i = 0; i < t.length; ++i)if (t[i]) {
                    o += "/" + t[i];
                    try {
                        n.mkdir(o, r);
                    } catch (a) {
            ...
            symlink (e, r) {
                if (!ge.resolve(e)) throw new n.ErrnoError(44);
                var t = n.lookupPath(r, {
                    parent: !0
                }), o = t.node;
                if (!o) throw new n.ErrnoError(44);
                var i = S.basename(r), a = n.mayCreate(o, i);
                if (a) throw new n.ErrnoError(a);
                if (!o.node_ops.symlink) throw new n.ErrnoError(63);
                return o.node_ops.symlink(o, i, e);
            },
            rename (e, r) {
                var t = S.dirname(e), o = S.dirname(r), i = S.basename(e), a = S.basename(r), u, f, v;
                if (u = n.lookupPath(e, {
                    parent: !0
                }), f = u.node, u = n.lookupPath(r, {
                    parent: !0
                }), v = u.node, !f || !v) throw new n.ErrnoError(44);
                if (f.mount !== v.mount) throw new n.ErrnoError(75);
                var F = n.lookupNode(f, i), b = ge.relative(e, o);
                if (b.charAt(0) !== ".") throw new n.ErrnoError(28);
                if (b = ge.relative(r, t), b.charAt(0) !== ".") throw new n.ErrnoError(55);
                var Y;
                try {
                    Y = n.lookupNode(v, a);
                } catch  {}
                if (F !== Y) {
                    var x = n.isDir(F.mode), w = n.mayDelete(f, i, x);
                    if (w) throw new n.ErrnoError(w);
                    if (w = Y ? n.mayDelete(v, a, x) : n.mayCreate(v, a), w) throw new n.ErrnoError(w);
                    if (!f.node_ops.rename) throw new n.ErrnoError(63);
                    if (n.isMountpoint(F) || Y && n.isMountpoint(Y)) throw new n.ErrnoError(10);
                    if (v !== f && (w = n.nodePermissions(f, "w"), w)) throw new n.ErrnoError(w);
                    n.hashRemoveNode(F);
                    try {
                        f.node_ops.rename(F, v, a), F.parent = v;
                    } catch (M) {
                        throw M;
                    } finally{
                        n.hashAddNode(F);
            ...
            rmdir (e) {
                var r = n.lookupPath(e, {
                    parent: !0
                }), t = r.node, o = S.basename(e), i = n.lookupNode(t, o), a = n.mayDelete(t, o, !0);
                if (a) throw new n.ErrnoError(a);
            ...
            unlink (e) {
                ...
                var o = S.basename(e), i = n.lookupNode(t, o), a = n.mayDelete(t, o, !1);
                if (a) throw new n.ErrnoError(a);
            ...
            open (e, r, t = 438) {
                ...
                r = typeof r == "string" ? _t(r) : r, r & 64 ? t = t & 4095 | 32768 : t = 0;
                var o;
                ...
                return f.stream_ops.open && f.stream_ops.open(f), f;
            },
            close (e) {
            ...
            read (e, r, t, o, i) {
                ...
                var u = e.stream_ops.read(e, r, t, o, i);
            ...
            write (e, r, t, o, i, a) {
                ...
                var f = e.stream_ops.write(e, r, t, o, i, a);
                return u || (e.position += f), f;
            },
            allocate (e, r, t) {
                if (n.isClosed(e)) throw new n.ErrnoError(8);
            ...
            readFile (e, r = {}) {
                ...
                var t, o = n.open(e, r.flags), i = n.stat(e), a = i.size, u = new Uint8Array(a);
                return n.read(o, u, 0, a, 0), r.encoding === "utf8" ? t = Re(u) : r.encoding === "binary" && (t = u), n.close(o), t;
            },
            writeFile (e, r, t = {}) {
                t.flags = t.flags || 577;
                var o = n.open(e, t.flags, t.mode);
                if (typeof r == "string") {
                    var i = new Uint8Array(er(r) + 1), a = rr(r, i, 0, i.length);
            ...
            createDefaultDevices () {
                n.mkdir("/dev"), n.registerDevice(n.makedev(1, 3), {
                    ...
                    write: (o, i, a, u, f)=>u,
                    llseek: ()=>0
                }), n.mkdev("/dev/null", n.makedev(1, 3)), Ge.register(n.makedev(5, 0), Ge.default_tty_ops), Ge.register(n.makedev(6, 0), Ge.default_tty1_ops), n.mkdev("/dev/tty", n.makedev(5, 0)), n.mkdev("/dev/tty1", n.makedev(6, 0));
                var e = new Uint8Array(1024), r = 0, t = ()=>(r === 0 && (r = pr(e).byteLength), e[--r]);
            ...
            createSpecialDirectories () {
                ...
                n.mkdir("/proc/self/fd"), n.mount({
                    mount () {
                        ...
                        return r.node_ops = {
                            lookup (t, o) {
                                var i = +o, a = n.getStreamChecked(i), u = {
                                    parent: null,
                                    mount: {
                                        mountpoint: "fake"
                                    },
            ...
            init (e, r, t) {
                n.initialized = !0, n.createStandardStreams(e, r, t);
            },
            quit () {
                n.initialized = !1;
            ...
            analyzePath (e, r) {
                ...
                try {
                    ...
                    o.parentExists = !0, o.parentPath = t.path, o.parentObject = t.node, o.name = S.basename(e), t = n.lookupPath(e, {
                        follow: !r
            ...
            createFile (e, r, t, o, i) {
                var a = S.join2(typeof e == "string" ? e : n.getPath(e), r), u = or(o, i);
                return n.create(a, u);
            },
            createDataFile (e, r, t, o, i, a) {
                var u = r;
                e && (e = typeof e == "string" ? e : n.getPath(e), u = r ? S.join2(e, r) : e);
                var f = or(o, i), v = n.create(u, f);
                if (t) {
                    if (typeof t == "string") {
                        for(var F = new Array(t.length), b = 0, Y = t.length; b < Y; ++b)F[b] = t.charCodeAt(b);
                        t = F;
                    }
                    n.chmod(v, f | 146);
                    var x = n.open(v, 577);
                    n.write(x, t, 0, t.length, 0, a), n.close(x), n.chmod(v, f);
                }
            },
            createDevice (e, r, t, o) {
                var i = S.join2(typeof e == "string" ? e : n.getPath(e), r), a = or(!!t, !!o);
                ...
                return n.registerDevice(u, {
                    ...
                    read (f, v, F, b, Y) {
                        for(var x = 0, w = 0; w < b; w++){
                            ...
                            if (M === void 0 && x === 0) throw new n.ErrnoError(6);
                            if (M == null) break;
                            x++, v[F + w] = M;
                        }
                        return x && (f.node.timestamp = Date.now()), x;
                    },
                    write (f, v, F, b, Y) {
                        for(var x = 0; x < b; x++)try {
                            o(v[F + x]);
                        } catch  {
                            throw new n.ErrnoError(29);
                        }
                        return b && (f.node.timestamp = Date.now()), x;
                    }
                }), n.mkdev(i, a, u);
            },
            forceLoadFile (e) {
            ...
            createLazyFile (e, r, t, o, i) {
                class a {
                    ...
                    get(w) {
                        if (!(w > this.length - 1 || w < 0)) {
                            var M = w % this.chunkSize, ee = w / this.chunkSize | 0;
                            return this.getter(ee)[M];
                        }
                    }
                    setDataGetter(w) {
                        this.getter = w;
                    ...
                    cacheLength() {
                        ...
                        if (w.open("HEAD", t, !1), w.send(null), !(w.status >= 200 && w.status < 300 || w.status === 304)) throw new Error("Couldn't load " + t + ". Status: " + w.status);
                        var M = Number(w.getResponseHeader("Content-length")), ee, le = (ee = w.getResponseHeader("Accept-Ranges")) && ee === "bytes", oe = (ee = w.getResponseHeader("Content-Encoding")) && ee === "gzip", de = 1024 * 1024;
                        le || (de = M);
                        var ve = (ye, Ye)=>{
                            if (ye > Ye) throw new Error("invalid range (" + ye + ", " + Ye + ") or no bytes requested!");
                            if (Ye > M - 1) throw new Error("only " + M + " bytes available! programmer error!");
                            var re = new XMLHttpRequest;
                            if (re.open("GET", t, !1), M !== de && re.setRequestHeader("Range", "bytes=" + ye + "-" + Ye), re.responseType = "arraybuffer", re.overrideMimeType && re.overrideMimeType("text/plain; charset=x-user-defined"), re.send(null), !(re.status >= 200 && re.status < 300 || re.status === 304)) throw new Error("Couldn't load " + t + ". Status: " + re.status);
                            return re.response !== void 0 ? new Uint8Array(re.response || []) : tr(re.responseText || "", !0);
                        }, Se = this;
                        Se.setDataGetter((ye)=>{
                            var Ye = ye * de, re = (ye + 1) * de - 1;
                            if (re = Math.min(re, M - 1), typeof Se.chunks[ye] > "u" && (Se.chunks[ye] = ve(Ye, re)), typeof Se.chunks[ye] > "u") throw new Error("doXHR failed!");
                            return Se.chunks[ye];
                        }), (oe || !M) && (de = M = 1, M = this.getter(0).length, de = M, L("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = M, this._chunkSize = de, this.lengthKnown = !0;
                    }
                    get length() {
                ...
                var v = n.createFile(e, r, f, o, i);
                f.contents ? v.contents = f.contents : f.url && (v.contents = null, v.url = f.url), Object.defineProperties(v, {
                    usedBytes: {
                        get: function() {
                ...
                var F = {}, b = Object.keys(v.stream_ops);
                b.forEach((x)=>{
                    var w = v.stream_ops[x];
                    F[x] = (...M)=>(n.forceLoadFile(v), w(...M));
                });
                function Y(x, w, M, ee, le) {
                    var oe = x.node.contents;
                    if (le >= oe.length) return 0;
                    var de = Math.min(oe.length - le, ee);
                    if (oe.slice) for(var ve = 0; ve < de; ve++)w[M + ve] = oe[le + ve];
                    else for(var ve = 0; ve < de; ve++)w[M + ve] = oe.get(le + ve);
                    return de;
                }
                return F.read = (x, w, M, ee, le)=>(n.forceLoadFile(v), Y(x, w, M, ee, le)), F.mmap = (x, w, M, ee, le)=>{
                    n.forceLoadFile(v);
                    var oe = Er(w);
                    if (!oe) throw new n.ErrnoError(48);
                    return Y(x, m, oe, w, M), {
                        ptr: oe,
                        allocated: !0
                    };
            ...
            doStat (e, r, t) {
                var o = e(r);
                B[t >> 2] = o.dev, B[t + 4 >> 2] = o.mode, R[t + 8 >> 2] = o.nlink, B[t + 12 >> 2] = o.uid, B[t + 16 >> 2] = o.gid, B[t + 20 >> 2] = o.rdev, N = [
                    o.size >>> 0,
                    (O = o.size, +Math.abs(O) >= 1 ? O > 0 ? +Math.floor(O / 4294967296) >>> 0 : ~~+Math.ceil((O - +(~~O >>> 0)) / 4294967296) >>> 0 : 0)
                ], B[t + 24 >> 2] = N[0], B[t + 28 >> 2] = N[1], B[t + 32 >> 2] = 4096, B[t + 36 >> 2] = o.blocks;
                var i = o.atime.getTime(), a = o.mtime.getTime(), u = o.ctime.getTime();
                return N = [
                    Math.floor(i / 1e3) >>> 0,
                    (O = Math.floor(i / 1e3), +Math.abs(O) >= 1 ? O > 0 ? +Math.floor(O / 4294967296) >>> 0 : ~~+Math.ceil((O - +(~~O >>> 0)) / 4294967296) >>> 0 : 0)
                ], B[t + 40 >> 2] = N[0], B[t + 44 >> 2] = N[1], R[t + 48 >> 2] = i % 1e3 * 1e3 * 1e3, N = [
                    Math.floor(a / 1e3) >>> 0,
                    (O = Math.floor(a / 1e3), +Math.abs(O) >= 1 ? O > 0 ? +Math.floor(O / 4294967296) >>> 0 : ~~+Math.ceil((O - +(~~O >>> 0)) / 4294967296) >>> 0 : 0)
                ], B[t + 56 >> 2] = N[0], B[t + 60 >> 2] = N[1], R[t + 64 >> 2] = a % 1e3 * 1e3 * 1e3, N = [
                    Math.floor(u / 1e3) >>> 0,
                    (O = Math.floor(u / 1e3), +Math.abs(O) >= 1 ? O > 0 ? +Math.floor(O / 4294967296) >>> 0 : ~~+Math.ceil((O - +(~~O >>> 0)) / 4294967296) >>> 0 : 0)
                ], B[t + 72 >> 2] = N[0], B[t + 76 >> 2] = N[1], R[t + 80 >> 2] = u % 1e3 * 1e3 * 1e3, N = [
                    o.ino >>> 0,
                    (O = o.ino, +Math.abs(O) >= 1 ? O > 0 ? +Math.floor(O / 4294967296) >>> 0 : ~~+Math.ceil((O - +(~~O >>> 0)) / 4294967296) >>> 0 : 0)
                ], B[t + 88 >> 2] = N[0], B[t + 92 >> 2] = N[1], 0;
            },
            doMsync (e, r, t, o, i) {
        ...
        function lt(e, r, t, o) {
            try {
                if (r = P.getStr(r), r = P.calculateAt(e, r), t & -8) return -28;
                var i = n.lookupPath(r, {
                    follow: !0
                }), a = i.node;
                if (!a) return -44;
                var u = "";
        ...
        function vt(e, r) {
            try {
                ...
                return P.doStat(n.stat, t.path, r);
            } catch (o) {
            ...
            try {
                ...
                switch(r){
                    ...
                    case 21505:
                        {
                            ...
                            if (o.tty.ops.ioctl_tcgets) {
                                var i = o.tty.ops.ioctl_tcgets(o), a = De();
                                B[a >> 2] = i.c_iflag || 0, B[a + 4 >> 2] = i.c_oflag || 0, B[a + 8 >> 2] = i.c_cflag || 0, B[a + 12 >> 2] = i.c_lflag || 0;
                    ...
                    case 21508:
                        {
                            ...
                            if (o.tty.ops.ioctl_tcsets) {
                                for(var a = De(), f = B[a >> 2], v = B[a + 4 >> 2], F = B[a + 8 >> 2], b = B[a + 12 >> 2], Y = [], u = 0; u < 32; u++)Y.push(m[a + u + 17]);
                    ...
                    case 21531:
                        {
                            var a = De();
                            return n.ioctl(o, r, a);
                        }
                    case 21523:
                        {
                            if (!o.tty) return -59;
                            if (o.tty.ops.ioctl_tiocgwinsz) {
                                var x = o.tty.ops.ioctl_tiocgwinsz(o.tty), a = De();
                                k[a >> 1] = x[0], k[a + 2 >> 1] = x[1];
                            }
                            return 0;
                        }
                    case 21524:
        ...
        function pt(e, r, t, o) {
            try {
                ...
                return o = o & -6401, r = P.calculateAt(e, r, a), P.doStat(i ? n.lstat : n.stat, r, t);
            } catch (u) {
        ...
        function yt(e, r, t, o) {
            ...
            try {
                ...
                var i = o ? We() : 0;
                return n.open(r, t, i).fd;
            } catch (a) {
                if (typeof n > "u" || a.name !== "ErrnoError") throw a;
                return -a.errno;
            }
        }
        var Ze = (e, r, t)=>rr(e, Q, r, t);
        function Et(e, r, t, o) {
            try {
                if (r = P.getStr(r), r = P.calculateAt(e, r), o <= 0) return -28;
                var i = n.readlink(r), a = Math.min(o, er(i)), u = m[t + a];
                return Ze(i, t, o + 1), m[t + a] = u, a;
            } catch (f) {
                if (typeof n > "u" || f.name !== "ErrnoError") throw f;
                return -f.errno;
            }
        ...
        function mt(e) {
            try {
                return e = P.getStr(e), n.rmdir(e), 0;
            } catch (r) {
        ...
        function wt(e, r) {
            try {
                return e = P.getStr(e), P.doStat(n.stat, e, r);
            } catch (t) {
        ...
        function Bt(e, r, t) {
            try {
                return r = P.getStr(r), r = P.calculateAt(e, r), t === 0 ? n.unlink(r) : t === 512 ? n.rmdir(r) : pe("Invalid flags passed to unlinkat"), 0;
            } catch (o) {
                if (typeof n > "u" || o.name !== "ErrnoError") throw o;
                return -o.errno;
            }
        }
        var gt = ()=>pe(""), Gt = 1, Ft = ()=>Gt, Lt = (e, r, t)=>Q.copyWithin(e, r, r + t), ir = (e, r)=>r + 2097152 >>> 0 < 4194305 - !!e ? (e >>> 0) + r * 4294967296 : NaN;
        function It(e, r, t, o, i, a, u, f) {
            var v = ir(i, a);
            try {
                if (isNaN(v)) return 61;
                var F = P.getStreamFromFD(o), b = n.mmap(F, e, v, r, t), Y = b.ptr;
                return B[u >> 2] = b.allocated, R[f >> 2] = Y, 0;
            } catch (x) {
                if (typeof n > "u" || x.name !== "ErrnoError") throw x;
                return -x.errno;
            }
        }
        function xt(e, r, t, o, i, a, u) {
            var f = ir(a, u);
            try {
                var v = P.getStreamFromFD(i);
                t & 2 && P.doMsync(e, v, r, o, f);
            } catch (F) {
                if (typeof n > "u" || F.name !== "ErrnoError") throw F;
                return -F.errno;
            }
        ...
        var Ot = (e, r, t, o)=>{
            var i = new Date().getFullYear(), a = new Date(i, 0, 1), u = new Date(i, 6, 1), f = a.getTimezoneOffset(), v = u.getTimezoneOffset(), F = Math.max(f, v);
            R[e >> 2] = F * 60, B[r >> 2] = +(f != v);
            var b = (w)=>{
                var M = w >= 0 ? "-" : "+", ee = Math.abs(w), le = String(Math.floor(ee / 60)).padStart(2, "0"), oe = String(ee % 60).padStart(2, "0");
                return `UTC${M}${le}${oe}`;
            }, Y = b(f), x = b(v);
            v < f ? (Ze(Y, t, 17), Ze(x, o, 17)) : (Ze(Y, o, 17), Ze(x, t, 17));
        }, ar = [], bt = (e, r)=>{
            ar.length = 0;
            for(var t; t = Q[e++];){
                var o = t != 105;
                o &= t != 112, r += o && r % 8 ? 4 : 0, ar.push(t == 112 ? R[r >> 2] : t == 105 ? B[r >> 2] : ne[r >> 3]), r += o ? 8 : 4;
            }
            return ar;
        }, Mt = (e, r, t)=>{
            var o = bt(r, t);
            return kr[e](...o);
        }, Rt = (e, r, t)=>Mt(e, r, t), Dt = ()=>Date.now(), Yt = ()=>2147483648, Pt = (e)=>{
            var r = X.buffer, t = (e - r.byteLength + 65535) / 65536 | 0;
            try {
                return X.grow(t), Z(), 1;
            } catch  {}
        }, Tt = (e)=>{
            ...
            for(var o = 1; o <= 4; o *= 2){
                ...
                var a = Math.min(t, nr(Math.max(e, i), 65536)), u = Pt(a);
                if (u) return !0;
            }
            return !1;
        }, sr = {}, Zt = ()=>j || "./this.program", ze = ()=>{
            if (!ze.strings) {
                ...
                for(var t in sr)sr[t] === void 0 ? delete r[t] : r[t] = sr[t];
                var o = [];
            ...
            var t = 0;
            return ze().forEach((o, i)=>{
                var a = r + t;
                R[e + i * 4 >> 2] = a, zt(o, a), t += o.length + 1;
            }), 0;
        }, jt = (e, r)=>{
            var t = ze();
            R[e >> 2] = t.length;
            var o = 0;
            return t.forEach((i)=>o += i.length + 1), R[r >> 2] = o, 0;
        }, Ut = ()=>!0, Ht = (e)=>{
            fe = e, Ut() || (W = !0), q(e, new Ar(e));
        }, Kt = (e, r)=>{
            fe = e, Ht(e);
        }, Qt = Kt;
        function Wt(e) {
        ...
        var Ct = (e, r, t, o)=>{
            for(var i = 0, a = 0; a < t; a++){
                var u = R[r >> 2], f = R[r + 4 >> 2];
                r += 8;
                var v = n.read(e, m, u, f, o);
                if (v < 0) return -1;
                if (i += v, v < f) break;
                typeof o < "u" && (o += v);
            }
        ...
        function Xt(e, r, t, o) {
            try {
                var i = P.getStreamFromFD(e), a = Ct(i, r, t);
                return R[o >> 2] = a, 0;
            } catch (u) {
                if (typeof n > "u" || u.name !== "ErrnoError") throw u;
                return u.errno;
        ...
        function $t(e, r, t, o, i) {
            ...
            try {
                ...
                var u = P.getStreamFromFD(e);
                return n.llseek(u, a, o), N = [
                    u.position >>> 0,
                    (O = u.position, +Math.abs(O) >= 1 ? O > 0 ? +Math.floor(O / 4294967296) >>> 0 : ~~+Math.ceil((O - +(~~O >>> 0)) / 4294967296) >>> 0 : 0)
                ], B[i >> 2] = N[0], B[i + 4 >> 2] = N[1], u.getdents && a === 0 && o === 0 && (u.getdents = null), 0;
            } catch (f) {
                if (typeof n > "u" || f.name !== "ErrnoError") throw f;
                return f.errno;
            }
        ...
        function qt(e, r, t, o) {
            try {
                var i = P.getStreamFromFD(e), a = Vt(i, r, t);
                return R[o >> 2] = a, 0;
            } catch (u) {
                if (typeof n > "u" || u.name !== "ErrnoError") throw u;
                return u.errno;
        ...
        n.createPreloadedFile = ft, n.staticInit(), g.doesNotExistError = new n.ErrnoError(44), g.doesNotExistError.stack = "<generic error, no stack>";
        var Jt = {
            a: tt,
            i: lt,
            f: dt,
        ...
        function Ur() {
            if (me > 0 || (Oe(), me > 0)) return;
            function e() {
                Ce || (Ce = !0, s.calledRun = !0, !W && (Pe(), d(s), Qe()));
            }
            e();
        }
        Ur();
        function ue() {}
        ue.prototype = Object.create(ue.prototype), ue.prototype.constructor = ue, ue.prototype.__class__ = ue, ue.__cache__ = {}, s.WrapperObject = ue;
        function Xe(e) {
            return (e || ue).__cache__;
        }
        s.getCache = Xe;
        function ur(e, r) {
            var t = Xe(r), o = t[e];
            return o || (o = Object.create((r || ue).prototype), o.ptr = e, t[e] = o);
        }
        s.wrapPointer = ur;
        function tn(e, r) {
            return ur(e.ptr, r);
        }
        s.castObject = tn, s.NULL = ur(0);
        function nn(e) {
        ...
        var D = {
            ...
            prepare () {
                if (D.needed) {
                    for(var e = 0; e < D.temps.length; e++)s._webidl_free(D.temps[e]);
                    D.temps.length = 0, s._webidl_free(D.buffer), D.buffer = 0, D.size += D.needed, D.needed = 0;
                }
                D.buffer || (D.size += 128, D.buffer = s._webidl_malloc(D.size), C(D.buffer)), D.pos = 0;
            },
            alloc (e, r) {
                C(D.buffer);
                var t = r.BYTES_PER_ELEMENT, o = e.length * t;
                o = nr(o, 8);
                var i;
                return D.pos + o >= D.size ? (C(o > 0), D.needed += o, i = s._webidl_malloc(o), D.temps.push(i)) : (i = D.buffer + D.pos, D.pos += o), i;
            },
            copy (e, r, t) {
                t /= r.BYTES_PER_ELEMENT;
                for(var o = 0; o < e.length; o++)r[t + o] = e[o];
            }
        };
        function ce(e) {
            if (typeof e == "string") {
                var r = tr(e), t = D.alloc(r, m);
                return D.copy(r, m, t), t;
            }
            return e;
        }
        function Ee() {
        ...
        Ee.prototype = Object.create(ue.prototype), Ee.prototype.constructor = Ee, Ee.prototype.__class__ = Ee, Ee.__cache__ = {}, s.VoidPtr = Ee, Ee.prototype.__destroy__ = Ee.prototype.__destroy__ = function() {
            var e = this.ptr;
            mr(e);
        };
        function y(e, r) {
            e && typeof e == "object" && (e = e.ptr), r && typeof r == "object" && (r = r.ptr), this.ptr = wr(e, r), Xe(y)[this.ptr] = this;
        }
        return y.prototype = Object.create(ue.prototype), y.prototype.constructor = y, y.prototype.__class__ = y, y.__cache__ = {}, s.Graphviz = y, y.prototype.version = y.prototype.version = function() {
            return se(Br());
        }, y.prototype.lastError = y.prototype.lastError = function() {
            return se(gr());
        }, y.prototype.createFile = y.prototype.createFile = function(e, r) {
            var t = this.ptr;
            D.prepare(), e && typeof e == "object" ? e = e.ptr : e = ce(e), r && typeof r == "object" ? r = r.ptr : r = ce(r), Gr(t, e, r);
        }, y.prototype.layout = y.prototype.layout = function(e, r, t) {
            var o = this.ptr;
            return D.prepare(), e && typeof e == "object" ? e = e.ptr : e = ce(e), r && typeof r == "object" ? r = r.ptr : r = ce(r), t && typeof t == "object" ? t = t.ptr : t = ce(t), se(Fr(o, e, r, t));
        }, y.prototype.acyclic = y.prototype.acyclic = function(e, r, t) {
            var o = this.ptr;
            return D.prepare(), e && typeof e == "object" ? e = e.ptr : e = ce(e), r && typeof r == "object" && (r = r.ptr), t && typeof t == "object" && (t = t.ptr), !!Lr(o, e, r, t);
        }, y.prototype.tred = y.prototype.tred = function(e, r, t) {
            var o = this.ptr;
            D.prepare(), e && typeof e == "object" ? e = e.ptr : e = ce(e), r && typeof r == "object" && (r = r.ptr), t && typeof t == "object" && (t = t.ptr), Ir(o, e, r, t);
        }, y.prototype.unflatten = y.prototype.unflatten = function(e, r, t, o) {
            var i = this.ptr;
            return D.prepare(), e && typeof e == "object" ? e = e.ptr : e = ce(e), r && typeof r == "object" && (r = r.ptr), t && typeof t == "object" && (t = t.ptr), o && typeof o == "object" && (o = o.ptr), se(xr(i, e, r, t, o));
        }, y.prototype.get_layout_result = y.prototype.get_layout_result = function() {
            var e = this.ptr;
            return se(Or(e));
        }, y.prototype.set_layout_result = y.prototype.set_layout_result = function(e) {
            var r = this.ptr;
            D.prepare(), e && typeof e == "object" ? e = e.ptr : e = ce(e), br(r, e);
        }, Object.defineProperty(y.prototype, "layout_result", {
            get: y.prototype.get_layout_result,
            set: y.prototype.set_layout_result
        }), y.prototype.get_acyclic_outFile = y.prototype.get_acyclic_outFile = function() {
            var e = this.ptr;
            return se(Mr(e));
        }, y.prototype.set_acyclic_outFile = y.prototype.set_acyclic_outFile = function(e) {
            var r = this.ptr;
            D.prepare(), e && typeof e == "object" ? e = e.ptr : e = ce(e), Rr(r, e);
        }, Object.defineProperty(y.prototype, "acyclic_outFile", {
            get: y.prototype.get_acyclic_outFile,
            set: y.prototype.set_acyclic_outFile
        }), y.prototype.get_acyclic_num_rev = y.prototype.get_acyclic_num_rev = function() {
            var e = this.ptr;
            return Dr(e);
        }, y.prototype.set_acyclic_num_rev = y.prototype.set_acyclic_num_rev = function(e) {
            var r = this.ptr;
            e && typeof e == "object" && (e = e.ptr), Yr(r, e);
        }, Object.defineProperty(y.prototype, "acyclic_num_rev", {
            get: y.prototype.get_acyclic_num_rev,
            set: y.prototype.set_acyclic_num_rev
        }), y.prototype.get_tred_out = y.prototype.get_tred_out = function() {
            var e = this.ptr;
            return se(Pr(e));
        }, y.prototype.set_tred_out = y.prototype.set_tred_out = function(e) {
            var r = this.ptr;
            D.prepare(), e && typeof e == "object" ? e = e.ptr : e = ce(e), Tr(r, e);
        }, Object.defineProperty(y.prototype, "tred_out", {
            get: y.prototype.get_tred_out,
            set: y.prototype.set_tred_out
        }), y.prototype.get_tred_err = y.prototype.get_tred_err = function() {
            var e = this.ptr;
            return se(Zr(e));
        }, y.prototype.set_tred_err = y.prototype.set_tred_err = function(e) {
            var r = this.ptr;
            D.prepare(), e && typeof e == "object" ? e = e.ptr : e = ce(e), zr(r, e);
        }, Object.defineProperty(y.prototype, "tred_err", {
            get: y.prototype.get_tred_err,
            set: y.prototype.set_tred_err
...
function bn(c, _) {
    ...
    [
        ...l.files,
        ...On(l.images)
    ].forEach((s)=>c.createFile(s.path, s.data));
}
var $r = class c {
    constructor(_){
        this._module = _;
    ...
    layout(_, l = "svg", s = "dot", d) {
        if (!_) return "";
        let h = new this._module.Graphviz(d?.yInvert ? 1 : 0, d?.nop ? d?.nop : 0), p = "", E = "";
        try {
            bn(h, d);
            try {
                p = h.layout(_, l, s);
        ...
        if (!p && E) throw c.unload(), new Error(E);
        return p;
    }
    acyclic(_, l = !1, s = !1) {
        if (!_) return {
        ...
        let d = new this._module.Graphviz, h = !1, p = 0, E = "", G = "";
        try {
            try {
                h = d.acyclic(_, l, s), p = d.acyclic_num_rev, E = d.acyclic_outFile;
            } catch (j) {
                G = j.message;
            }
            G = d.lastError() || G;
        ...
        if (G) throw c.unload(), new Error(G);
        return {
            acyclic: h,
            num_rev: p,
            outFile: E
    ...
    tred(_, l = !1, s = !1) {
        ...
        let d = new this._module.Graphviz, h = "", p = "", E = "";
        try {
            try {
                d.tred(_, l, s), h = d.tred_out, p = d.tred_err;
            } catch (G) {
                E = G.message;
            }
            E = d.lastError() || E;
        ...
        if (!h && E) throw c.unload(), new Error(E);
        return {
            out: h,
            err: p
        };
    }
    unflatten(_, l = 0, s = !1, d = 0) {
        if (!_) return "";
        let h = new this._module.Graphviz, p = "", E = "";
        try {
            try {
                p = h.unflatten(_, l, s, d);
            } catch (G) {
                E = G.message;
            }
            E = h.lastError() || E;
    ...
    circo(_, l = "svg", s) {
        return this.layout(_, l, "circo", s);
    }
    dot(_, l = "svg", s) {
        return this.layout(_, l, "dot", s);
    }
    fdp(_, l = "svg", s) {
        return this.layout(_, l, "fdp", s);
    }
    sfdp(_, l = "svg", s) {
        return this.layout(_, l, "sfdp", s);
    }
    neato(_, l = "svg", s) {
        return this.layout(_, l, "neato", s);
    }
    osage(_, l = "svg", s) {
        return this.layout(_, l, "osage", s);
    }
    patchwork(_, l = "svg", s) {
        return this.layout(_, l, "patchwork", s);
    }
    twopi(_, l = "svg", s) {
        return this.layout(_, l, "twopi", s);
    }
    nop(_) {
        return this.layout(_, "dot", "nop");
    }
    nop2(_) {
        return this.layout(_, "dot", "nop2");
    }
};
;
}}),
...
//# sourceMappingURL=node_modules_%40hpcc-js_wasm-graphviz_dist_index_d372381b.js.map