        ...
        <Box className="shift" sx={{transition:'all 300ms ease'}}>
            {
                ...
                <Box sx={{marginBlock:'8px', position:'relative'}}>
                    <pre style={{margin:0}}>
                        <code className={`language-${props.language} hljs print-no-style`} style={{minHeight:300, margin: 0, overflow:'auto'}} dangerouslySetInnerHTML={{__html: props.highlight}}></code>
                    </pre>
